    ...
    if (resources.length < 1) {
        ...
        $.each(resources, function (i, resource) {
            ...
            contentHtml += "<div class='row content-box rounded' data-id='" + resource.id + "'><div class='col-12 col-sm-12'><br/><div class='row'>" +
                ...
                "</h4><p>上传者：<b>" + resource.username + "</b>&emsp;" + (isDownloaded ? "下载" : "上传") + "时间：<b>" + new Date(date).format("yyyy-MM-dd hh:mm:ss") + "</b>&emsp;文档大小：<b>" + formatSize(resource.size) + "</b>&emsp;分类：<b class='file-category'>" + resource.categoryName + "</b>" +
...
function removeFile() {
    var contentBox = $(event.srcElement).parents(".content-box");
    layer.confirm('是否确定删除文档【' + $(contentBox).find("a.visit-url").text() + '】', {
        btn: ['确定', '删除'],
