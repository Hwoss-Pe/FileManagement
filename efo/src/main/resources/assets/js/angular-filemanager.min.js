!function (e, r) {
    ...
    angular.module("FileManagerApp").config(["$translateProvider", function (e) {
        e.useSanitizeValueStrategy(null), e.translations("en", {
            ...
            close: "关闭",
            upload_files: "上传文档",
            files_will_uploaded_to: "文档将上传到",
            select_files: "选择文档",
            uploading: "上传中",
            permissions: "权限",
            select_destination_folder: "选择目标文档",
            source: "源自",
            destination: "目的地",
            copy_file: "复制文档",
            ...
            enter_folder_name_for_extraction: "输入解压的目标文档夹",
            enter_file_name_for_compression: "输入要压缩的文档名",
            ...
            date: "日期",
            selection: "选择",
            no_files_in_folder: "此文档夹没有文档",
            no_folders_in_folder: "此文档夹不包含子文档夹",
            select_this: "选择此文档",
            go_back: "后退",
            wait: "等待",
            move: "移动",
            ...
            extract: "解压",
            compress: "压缩",
            error_invalid_filename: "非法文档名或文档已经存在, 请指定其它名称",
            error_modifying: "修改文档出错",
            error_deleting: "删除文档或文档夹出错",
            error_renaming: "重命名文档出错",
            error_copying: "复制文档出错",
            error_compressing: "压缩文档或文档夹出错",
            error_extracting: "解压文档出错",
            error_creating_folder: "创建文档夹出错",
            error_getting_content: "获取文档内容出错",
            error_changing_perms: "修改文档权限出错",
            error_uploading_files: "上传文档出错",
