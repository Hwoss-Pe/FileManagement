...
import com.hwoss.service.IFileService;
import com.hwoss.util.BeanUtils;
...
@RestController
@RequestMapping("/file")
@Api(value = "/file", description = "文档相关操作")
public class FileController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "categoryId", value = "分类ID", required = true), @ApiImplicitParam
            (name = "tag", value = "文档标签"), @ApiImplicitParam(name = "description", value = "文档描述"),
            @ApiImplicitParam(name = "prefix", value = "文档前缀（仅适用于管理员上传文档，普通用户无效）")})
    @AuthInterceptor(InterceptorLevel.USER)
    ...
    @ApiOperation(value = "更新文档属性")
    @ApiImplicitParams({@ApiImplicitParam(name = "name", value = "文档名", required = true), @ApiImplicitParam(name =
            "category", value = "分类名称", required = true), @ApiImplicitParam(name = "tag", value = "文档标签", required =
            true), @ApiImplicitParam(name = "description", value = "文档描述", required = true)})
    @AuthInterceptor(InterceptorLevel.USER)
    ...
    @ApiOperation(value = "获取所有文档的基本信息")
    @ApiImplicitParams({@ApiImplicitParam(name = "user", value = "指定用户（默认所有用户）"), @ApiImplicitParam(name = "file",
            value = "指定文档（默认所有文档）"), @ApiImplicitParam(name = "category", value = "指定分类（默认所有分类）"), @ApiImplicitParam
    ...
    @ApiOperation(value = "通过文档路径获取服务器端的文档")
    @ApiImplicitParam(name = "path", value = "文档路径（默认根目录）")
    @AuthInterceptor(InterceptorLevel.ADMIN)
    ...
    @ApiOperation(value = "更新文档路径（包括本地路径，访问路径，如果新的本地路径和访问路径均为空，这什么也不会做）")
    @ApiImplicitParams({@ApiImplicitParam(name = "oldLocalUrl", value = "文档本地路径", required = true), @ApiImplicitParam
    ...
    @ApiOperation(value = "获取指定文档的权限记录")
    @AuthInterceptor(InterceptorLevel.ADMIN)
     ...
     */
    @ApiOperation(value = "通过访问路径获取文档资源")
    @AuthInterceptor(InterceptorLevel.NONE)
